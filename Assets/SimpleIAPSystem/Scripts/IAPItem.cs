...
namespace SIS
{
    ...
    public class IAPItem : MonoBehaviour
    {
        ...
        /// based on IAPObject set in IAP Settings editor.
        ...
        /// received from the billing plugin initialization callback.
        /// Called by ShopManager
        /// </summary>
        public void Init(Product product)
        {
            ...
            //so we just use the first entry of the price label array
            if (price.Length > 0) price[0].text = product.metadata.localizedPriceString;
        }
        ...
        public void Purchased(bool state)
        {
            ...
            if (obj.type == ProductType.Subscription) return;
